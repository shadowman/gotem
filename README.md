#Symfony 2 Project - Development setup
...
* Clone this repository
    ...
    ```$ git clone git@git.runroom.com:project-startup-template.git```
...
4 - Commit to remote repository if needed

You can automate steps 2 and 3 by calling init-project.sh script
